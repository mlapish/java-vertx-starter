podTemplate(label: 'buildpod', inheritFrom: 'maven', serviceAccount: 'builder', cloud: 'openshift', containers: [
    containerTemplate(name: 'jnlp', privileged: true, image: 'openshift/jenkins-slave-maven-centos7',
           envVars: [
